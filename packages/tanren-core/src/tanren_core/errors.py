...
class ErrorClass(enum.Enum):
    """Classification of agent errors for retry decisions."""
...
def classify_error(
    ...
    """Classify an agent error as transient, fatal, or ambiguous.

    Returns:
        ErrorClass categorization for retry decisions.
    """
    combined = f"{stdout}\n{stderr}"
