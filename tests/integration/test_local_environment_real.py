...
async def test_real_local_provision(tmp_path):  # noqa: RUF029 — stub test, will use async when implemented
...
@pytest.mark.usefixtures("_require_git")
async def test_real_local_env_validation(tmp_path):  # noqa: RUF029 — stub test, will use async when implemented
