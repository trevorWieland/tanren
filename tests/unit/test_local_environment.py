...
class TestExecute:
    ...
    @pytest.mark.asyncio
    @patch("tanren_core.adapters.local_environment.compute_plan_hash", new_callable=AsyncMock)
    @patch(
        "tanren_core.adapters.local_environment.count_unchecked_tasks",
        new_callable=AsyncMock,
    )
    @patch("tanren_core.adapters.local_environment.map_outcome")
    @patch("tanren_core.adapters.local_environment.extract_signal")
