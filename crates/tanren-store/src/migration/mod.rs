...
mod m20260506_000004_existing_account_join;
mod m20260506_000005_membership_departure;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260506_000004_existing_account_join::Migration),
            Box::new(m20260506_000005_membership_departure::Migration),
        ]
    }
}
