...
mod m20260506_000001_user_configuration;
mod m20260506_000002_notification_preferences;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260506_000001_user_configuration::Migration),
            Box::new(m20260506_000002_notification_preferences::Migration),
        ]
    }
}
