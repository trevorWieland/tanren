...
pub use configuration::{
    ...
    CredentialCapabilityAction, GetAuthenticatedUserConfigurationCapabilitiesResponse,
    ListUserCredentialsRequest, ListUserCredentialsResponse, ListUserSettingsRequest,
    ListUserSettingsResponse, MAX_PAGE_LIMIT, OwnerScope, RemoveUserCredentialResponse,
    RemoveUserSettingResponse, SETTING_CAPABILITY_ACTIONS, SUPPORTED_THEME_PREFERENCES,
    SUPPORTED_USER_CREDENTIAL_KINDS, SUPPORTED_USER_SETTING_KEYS, SettingCapabilitiesView,
    SettingCapabilityAction, ThemePreference, USER_CREDENTIAL_KIND_DESCRIPTORS,
