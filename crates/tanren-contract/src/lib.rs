...
pub use configuration::{
    CREDENTIAL_CAPABILITY_ACTIONS, ConfigurationCapabilitiesView, ConfigurationCapabilityRegistry,
    ConfigurationValidationFailure, ConfigurationVersion, CreateUserCredentialRequest,
    ...
    RemoveUserCredentialResponse, RemoveUserSettingResponse, SETTING_CAPABILITY_ACTIONS,
    SUPPORTED_THEME_PREFERENCES, SUPPORTED_USER_CREDENTIAL_KINDS, SUPPORTED_USER_SETTING_KEYS,
    SettingCapabilitiesView, SettingCapabilityAction, ThemePreference,
