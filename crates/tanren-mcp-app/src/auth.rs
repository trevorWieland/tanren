//! API-key auth middleware and helpers.
//!
//! Extracted from `lib.rs` to keep the main module under the workspace
//! 500-line line-budget while adding the upgrade tool surface.
