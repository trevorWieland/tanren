...
pub use harness::{
    ...
    ConfigurationHarness, HarnessAcceptance, HarnessConfigEntry, HarnessCredential, HarnessError,
    HarnessInvitation, HarnessKind, HarnessOutcome, HarnessResult, HarnessSession,
    InProcessHarness, McpHarness, TuiHarness, WebHarness, event_kinds, record_failure,
};
