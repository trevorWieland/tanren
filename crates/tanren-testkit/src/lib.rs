...
pub use harness::{
    ...
    HarnessSession, InProcessHarness, McpHarness, ProjectApiHarness, ProjectCliHarness,
    ProjectHarness, ProjectInProcessHarness, ProjectMcpHarness, ProjectOutcome, ProjectTuiHarness,
