...
pub use harness::{
    ...
    HarnessAcceptance, HarnessError, HarnessInvitation, HarnessKind, HarnessOrganization,
    HarnessOutcome, HarnessProject, HarnessResult, HarnessSession, InProcessHarness, McpHarness,
