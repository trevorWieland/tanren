...
pub fn load_managed_branch_payload(
    checkout_root: &Path,
) -> Result<ManagedBranchPayload, InstallProofError> {
    ManagedBranchPayload::from_checkout_root(checkout_root)
}
...
pub fn assert_rust_cargo_default_assets_installed(
    payload: &ManagedBranchPayload,
) -> Result<(), InstallProofError> {
    contract::assert_rust_cargo_default_assets_installed(payload)
}
...
pub fn assert_rust_cargo_standards_installed(
    ...
    contract::assert_rust_cargo_standards_installed(payload)
}
...
pub fn assert_selected_integration_command_assets(
    ...
    contract::assert_selected_integration_command_assets(payload, selected_integrations)
}
...
pub fn assert_manifest_rust_cargo_defaults(
    ...
    contract::assert_manifest_rust_cargo_defaults(payload)
}
