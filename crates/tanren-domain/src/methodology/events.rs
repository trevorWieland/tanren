...
pub use crate::methodology::lifecycle_events::{
...
pub enum MethodologyEvent {
    ...
    FindingReopened(FindingReopened),
    FindingDeferred(FindingDeferred),
    FindingSuperseded(FindingSuperseded),
    FindingStillOpen(FindingStillOpen),
    CheckRunStarted(CheckRunStarted),
    CheckResultRecorded(CheckResultRecorded),
    CheckFailureRecorded(CheckFailureRecorded),
    InvestigationAttemptRecorded(InvestigationAttemptRecorded),
    RootCauseLinkedToFinding(RootCauseLinkedToFinding),
...
impl MethodologyEvent {
    ...
    pub fn entity_root(&self) -> EntityRef {
        match self {
            ...
            Self::FindingResolved(e) => EntityRef::Finding(e.finding_id),
            Self::FindingReopened(e) => EntityRef::Finding(e.finding_id),
            Self::FindingDeferred(e) => EntityRef::Finding(e.finding_id),
            Self::FindingSuperseded(e) => EntityRef::Finding(e.finding_id),
            Self::FindingStillOpen(e) => EntityRef::Finding(e.finding_id),
            Self::CheckRunStarted(e) => EntityRef::Spec(e.check.spec_id),
            Self::CheckResultRecorded(e) => EntityRef::Spec(e.result.spec_id),
            Self::CheckFailureRecorded(e) => EntityRef::Spec(e.result.spec_id),
            Self::InvestigationAttemptRecorded(e) => EntityRef::Spec(e.attempt.spec_id),
            Self::RootCauseLinkedToFinding(e) => EntityRef::Finding(e.finding_id),
    ...
    pub fn spec_id(&self) -> Option<SpecId> {
        match self {
            ...
            Self::FindingResolved(e) => Some(e.spec_id),
            Self::FindingReopened(e) => Some(e.spec_id),
            Self::FindingDeferred(e) => Some(e.spec_id),
            Self::FindingSuperseded(e) => Some(e.spec_id),
            Self::FindingStillOpen(e) => Some(e.spec_id),
            Self::CheckRunStarted(e) => Some(e.check.spec_id),
            Self::CheckResultRecorded(e) => Some(e.result.spec_id),
            Self::CheckFailureRecorded(e) => Some(e.result.spec_id),
            Self::InvestigationAttemptRecorded(e) => Some(e.attempt.spec_id),
            Self::RootCauseLinkedToFinding(e) => Some(e.spec_id),
