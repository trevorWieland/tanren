...
export interface paths {
  ...
  "/account/organizations/active": {
     ...
     */
    post: operations["switch_active_org_route"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/account/organizations/active/projects": {
     ...
     */
    get: operations["list_active_org_projects_route"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
     ...
     */
    Identifier: string;
    /** @description Successful organization-scoped project list response. */
    ListOrganizationProjectsResponse: {
      /** @description Projects belonging to the requested organization. */
    ...
    OrgId: string;
    /**
     * @description View of an organization the caller belongs to, used by the
    ...
    /**
     * @description Organization switcher state — lists organizations the caller belongs
    ...
    OrganizationSwitcher: {
      active_org?: null | components["schemas"]["OrgId"];
      /** @description Organizations the account is a member of. */
      memberships: components["schemas"]["OrganizationMembershipView"][];
    };
    /** Format: uuid */
    ProjectId: string;
    /** @description External-facing view of a project within an organization. */
    ProjectView: {
    ...
    /** @description Request to switch the active organization for the caller's account. */
    SwitchActiveOrganizationRequest: {
      /** @description Target organization to make active. */
      org_id: components["schemas"]["OrgId"];
    };
    /** @description Successful switch-active-organization response. */
    SwitchActiveOrganizationResponse: {
      /** @description Updated account view reflecting the new active organization. */
      account: components["schemas"]["AccountView"];
    };
  };
  responses: never;
...
export interface operations {
  list_organizations_route: {
    ...
    requestBody?: never;
    responses: {
      /** @description Organization memberships listed */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": components["schemas"]["OrganizationSwitcher"];
        };
      };
  ...
  switch_active_org_route: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["SwitchActiveOrganizationResponse"];
        };
      };
      /** @description unauthenticated */
      401: {
      ...
      /** @description organization_not_member */
      403: {
        headers: {
          [name: string]: unknown;
        };
