    ...
    ($(
        ...
        $(
            fn $id<'a>(
                ...
                Box::pin(async move {
                    match decode::<$params_type>(descriptor($tool_id).name, args) {
        ...
        const REGISTRY: &[ToolRegistration] = &[
            $(
                ToolRegistration {
                    ...
                    schema_builder: schema_object::<$params_type>,
                    dispatch: $id,
                },
            )+
        ];
...
define_tools! {
    ...
    { id: dispatch_list_findings, tool_id: ToolId::ListFindings, description: "Read-only: list findings with projected lifecycle status.", params: tanren_contract::methodology::ListFindingsParams, method: list_findings, },
    { id: dispatch_resolve_finding, tool_id: ToolId::ResolveFinding, description: "Resolve a finding with verification evidence.", params: tanren_contract::methodology::FindingLifecycleParams, method: resolve_finding, },
    { id: dispatch_reopen_finding, tool_id: ToolId::ReopenFinding, description: "Reopen a finding with recurrence evidence.", params: tanren_contract::methodology::FindingLifecycleParams, method: reopen_finding, },
    { id: dispatch_defer_finding, tool_id: ToolId::DeferFinding, description: "Defer a finding with rationale/evidence.", params: tanren_contract::methodology::FindingLifecycleParams, method: defer_finding, },
    { id: dispatch_supersede_finding, tool_id: ToolId::SupersedeFinding, description: "Supersede a finding with replacement finding ids.", params: tanren_contract::methodology::SupersedeFindingParams, method: supersede_finding, },
    { id: dispatch_record_finding_still_open, tool_id: ToolId::RecordFindingStillOpen, description: "Record a failed recheck for an open finding.", params: tanren_contract::methodology::FindingLifecycleParams, method: record_finding_still_open, },
    {
    ...
    {
        id: dispatch_set_spec_problem_statement,
        tool_id: ToolId::SetSpecProblemStatement,
        description: "Set the spec's problem statement.",
        params: tanren_contract::methodology::SetSpecProblemStatementParams,
        method: set_spec_problem_statement,
    },
    {
        id: dispatch_set_spec_motivations,
        tool_id: ToolId::SetSpecMotivations,
        description: "Full-replace the spec motivations list.",
        params: tanren_contract::methodology::SetSpecMotivationsParams,
        method: set_spec_motivations,
    },
    {
        id: dispatch_set_spec_expectations,
        tool_id: ToolId::SetSpecExpectations,
        description: "Full-replace the spec expectations list.",
        params: tanren_contract::methodology::SetSpecExpectationsParams,
        method: set_spec_expectations,
    },
    {
        id: dispatch_set_spec_planned_behaviors,
        tool_id: ToolId::SetSpecPlannedBehaviors,
        description: "Full-replace the planned-behaviors list for this spec.",
        params: tanren_contract::methodology::SetSpecPlannedBehaviorsParams,
        method: set_spec_planned_behaviors,
    },
    {
        id: dispatch_set_spec_implementation_plan,
        tool_id: ToolId::SetSpecImplementationPlan,
        description: "Full-replace the ordered implementation plan steps.",
        params: tanren_contract::methodology::SetSpecImplementationPlanParams,
        method: set_spec_implementation_plan,
    },
    {
    ...
    { id: dispatch_start_check_run, tool_id: ToolId::StartCheckRun, description: "Start a generic check run.", params: tanren_contract::methodology::StartCheckRunParams, method: start_check_run, },
    { id: dispatch_record_check_result, tool_id: ToolId::RecordCheckResult, description: "Record a generic check result.", params: tanren_contract::methodology::RecordCheckResultParams, method: record_check_result, },
    { id: dispatch_record_check_failure, tool_id: ToolId::RecordCheckFailure, description: "Record a generic check failure.", params: tanren_contract::methodology::RecordCheckResultParams, method: record_check_failure, },
    { id: dispatch_record_investigation_attempt, tool_id: ToolId::RecordInvestigationAttempt, description: "Record a durable investigation attempt.", params: tanren_contract::methodology::RecordInvestigationAttemptParams, method: record_investigation_attempt, },
    { id: dispatch_list_investigation_attempts, tool_id: ToolId::ListInvestigationAttempts, description: "List durable investigation attempts for a fingerprint.", params: tanren_contract::methodology::ListInvestigationAttemptsParams, method: list_investigation_attempts, },
    { id: dispatch_link_root_cause_to_finding, tool_id: ToolId::LinkRootCauseToFinding, description: "Link an investigation root cause to a finding.", params: tanren_contract::methodology::LinkRootCauseToFindingParams, method: link_root_cause_to_finding, },
    {
    ...
    },
    {
        ...
        description: "Read-only: the installed standards applicable to a spec.",
