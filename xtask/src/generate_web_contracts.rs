...
fn render_header(rendered: &mut String) {
    ...
    rendered.push_str("// Generator: `xtask/src/generate_web_contracts.rs`.\n");
    rendered.push_str(
        "// Source crates: `crates/tanren-contract` and `crates/tanren-identity-policy` JsonSchema derives.\n\n",
    );
