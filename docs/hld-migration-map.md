...
| Command files inventory | [`methodology/system.md#command-organization`](methodology/system.md#command-organization) |
...
| Bootstrapping a project | [`../README.md#quick-start-canonical-runtime-contract`](../README.md#quick-start-canonical-runtime-contract) + [`getting-started/bootstrap.md`](getting-started/bootstrap.md) |
| One-off bootstrap commands | [`getting-started/bootstrap.md`](getting-started/bootstrap.md) |
| Setup tanren execution (`tanren.yml`, `remote.yml`, `roles.yml`) | [`getting-started/bootstrap.md`](getting-started/bootstrap.md) |
...
| Agent roles and role separation rationale | [`methodology/system.md#role-separation`](methodology/system.md#role-separation) + [`methodology/system.md`](methodology/system.md) |
...
| Environment profiles and debug handoff | [`ADAPTERS.md#execution-contract`](ADAPTERS.md#execution-contract) |
...
| Metering and observability | [`ADAPTERS.md#contract-surface`](ADAPTERS.md#contract-surface) + [`operations/observability.md`](operations/observability.md) |
