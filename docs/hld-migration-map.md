...
| Execution environment lifecycle | [`../README.md#execution-environments`](../README.md#execution-environments) + [`../worker-manager/README.md#execution-environments`](../worker-manager/README.md#execution-environments) |
| Sub-adapter decomposition | [`../worker-manager/ADAPTERS.md`](../worker-manager/ADAPTERS.md) |
| Agent-proof remote design | [`../worker-manager/ADAPTERS.md`](../worker-manager/ADAPTERS.md) |
| Environment profiles and debug handoff | [`../worker-manager/README.md#remote-execution-setup`](../worker-manager/README.md#remote-execution-setup) + [`../worker-manager/README.md#vm-management`](../worker-manager/README.md#vm-management) |
...
| Current/planned adapters | [`../worker-manager/ADAPTERS.md`](../worker-manager/ADAPTERS.md) + [`roadmap.md`](roadmap.md) |
...
| Metering and observability | [`../worker-manager/README.md#event-system`](../worker-manager/README.md#event-system) + [`operations/observability.md`](operations/observability.md) |
