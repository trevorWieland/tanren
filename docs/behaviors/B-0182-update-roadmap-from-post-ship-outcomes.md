...
A `solo-builder` or `team-builder` can update roadmap and specs from post-ship outcomes so Tanren closes the loop between delivery and product learning.
...
- Automatically pivoting the product without review.
- Discarding prior roadmap rationale when outcomes change.
