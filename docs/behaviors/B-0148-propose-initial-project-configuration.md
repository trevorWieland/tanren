---
id: B-0148
title: Review initial project configuration proposals from repo evidence
...
proposals derived from repository evidence so setup reflects how the project
already works without applying inferred settings blindly.

## Preconditions

- Repository analysis has produced configuration evidence.
