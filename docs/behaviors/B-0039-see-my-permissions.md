...
- For each permission, the user can see how they received it — for example
  an individual grant, a role that was applied, or an organization-level
  policy.
